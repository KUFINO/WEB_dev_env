...
const LoginPage: React.FC = () => {
  return (
    <div className="bg-sparkler flex h-screen w-full">
      <div className="hidden lg:flex lg:w-1/2 bg-login_side bg-no-repeat bg-cover items-end justify-center pb-10">
      ...
      <div className="w-full h-full bg-sparkler lg:w-1/2 p-4 sm:p-6 md:p-8 lg:p-10 flex items-center justify-center">
        <SignupForm />
      </div>
    </div>
  );
