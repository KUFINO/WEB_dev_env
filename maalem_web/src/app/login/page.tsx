...
const LoginPage: React.FC = () => {
  return (
    <div className="bg-sparkler flex flex-col h-screen w-full lg:flex-row">
      <div className="hidden  h-[99%] w-[95%] mt-1 bg-login_side bg-no-repeat bg-cover flex items-end justify-center pb-10 rounded-[25px] sm:w-[98%] sm:ml-[0.40rem] md:w-[98%] md:ml-2 lg:ml-3 lg:flex-[0_0_50%] lg:flex ">
